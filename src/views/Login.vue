    ...
    <v-container class="grey lighten-5 mb-6 my-5">
        ...
        <v-row no-gutters justify="center" align="center">
            <v-col cols="5" class="text-center mx-5" justify="center">
                ...
                <v-btn class="mt-2 ma-5" tile color="#d6e0f5" @click="signUpRedirect">
                ...
                <v-btn class="ma-2" tile color="#d6e0f5" @click="forgotpasswordRedirect">
                    <v-icon left color="white">
        ...
        return {
            users: {
                user1: {
                    ...
                    role: 'developer',
                    uid: '5XdfgY32XNNY',
                    image: 'https://icon-library.com/images/manager-512.png'
                },
                user2: {
                    firstName: 'user2',
                    lastName: 'lastName 2',
                    role: 'developer',
                    uid: '5XdfgY32XNNY',
                    image: 'https://cdn.iconscout.com/icon/premium/png-512-thumb/businessman-10-132143.png'
                },
                user3: {
                    firstName: 'user3',
                    lastName: 'lastName 3',
                    role: 'developer',
                    uid: '5XdfgY32XNNY',
                    image: 'https://cdn.iconscout.com/icon/premium/png-512-thumb/employee-417-789460.png'
                },
                user4: {
                    firstName: 'user4',
                    lastName: 'lastName 4',
                    role: 'developer',
                    uid: '5XdfgY32XNNY',
                    image: 'https://cdn.iconscout.com/icon/free/png-512/avatar-373-456325.png'
                },
                user5: {
                    firstName: 'user5',
                    lastName: 'lastName 5',
                ...
                user6: {
                    ...
                    role: 'developer',
                    uid: '5XdfgY32XNNY',
                    image: 'https://crisstalinconstructii.ro/wp-content/uploads/2021/03/baiat.png'
                },
